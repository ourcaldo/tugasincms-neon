...
export function JobTagsList() {
  ...
  const fetchTags = async () => {
    try {
      ...
      toast.error('Failed to load job tags')
      setTags([])
      setTotalTags(0)
    } finally {
      setLoading(false)
  ...
  const handleBulkDelete = async () => {
    ...
    try {
      ...
      toast.success('Selected job tags deleted successfully')
    } catch (error) {
  ...
  const openEditDialog = (tag: JobTag) => {
    setEditingTag(tag)
    setFormData({
      name: tag.name,
      slug: tag.slug,
    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              <DialogTitle>Create New Job Tag</DialogTitle>
            </DialogHeader>
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Enter job tag name"
                />
              </div>
              <div className="space-y-2">
                  ...
                  <TableRow>
                    <TableHead className="w-10">
                      <Checkbox 
                        ...
                        aria-label="Select all job tags on this page"
                      />
                    </TableHead>
                    ...
                    <TableRow key={tag.id}>
                      <TableCell>
                        <Checkbox 
                          ...
                          aria-label={`Select job tag ${tag.name}`}
                        />
                      </TableCell>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Edit Job Tag</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
